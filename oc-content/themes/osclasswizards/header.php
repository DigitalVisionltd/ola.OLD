...
<?php /* KYR START  replace this line with below line for hide subcategories from search see function.php: ?>
                  <?php osc_categories_select('sCategory', null, osc_esc_html(__('Select a category', OSCLASSWIZARDS_THEME_FOLDER))) ; ?>
<?php /* KYR END */ ?>
                  <?php cust_parent_categories_select('sCategory', null, osc_esc_html(__('Select a category', OSCLASSWIZARDS_THEME_FOLDER))) ; ?>
                </div>
                <?php  } ?>
              </div>
              <?php if($showCountry) { ?>
              ...
              <?php } ?>
<?php /* KYR START hide region & city from search / ?>
              <div class="col-md-2">
                <div class="cell selector">
