...
class prziAjaxUploader {
    ...
    function __construct(array $allowedExtensions = null, $sizeLimit = null) {
        ...
        if (!Params::existServerParam('CONTENT_TYPE')) {
            ...
            $this->_file = new prziAjaxUploadedFileForm();
        } else {
            $this->_file = new prziAjaxUploadedFileXhr();
        }
    }
    ...
    function handleUpload($uploadFilename, $replace = false) {
        ...
        $ext = pathinfo(Params::getParam('qqfilename'), PATHINFO_EXTENSION);
...
class prziAjaxUploadedFileForm {
    private $_file;
